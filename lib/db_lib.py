...
def get_db_connection():
    ...
    :return:
    """
    conn = MySQLdb.connect(host=db_config.db_host, user=db_config.db_username, passwd=db_config.db_password,
                           db=db_config.db_name, port=db_config.db_port, charset="utf8")
    return conn
